...
# Revisión mensual de cambios upstream: R for Data Science
...
- **Upstream:** `hadley/r4ds`, rama `main`
...
`hadley/r4ds` rama `main` de los últimos 30 días (desde
...
en la rama `main` de `hadley/r4ds`.
