...
-   Usa `geom_rect()` para dibujar un rectángulo alrededor de los puntos de interés.
    ...
    Alternativamente, consulte el [paquete ggforce](https://ggforce.data-imaginist.com/index.html), específicamente [`geom_mark_hull()`](https://ggforce.data-imaginist.com/reference/geom_mark_hull.html), que le permite anotar subconjuntos de puntos con cascos.
